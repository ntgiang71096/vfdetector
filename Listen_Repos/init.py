from util import initiate_database, checkdatabase
from gitrepo_listen import listen_body
import schedule
import time
...
if __name__ == '__main__':
    ...
    # set the github repo url and corresponding listening period (in terms of seconds)
    ...
    schedule.every(listen_period).seconds.do(listen_body,url)
